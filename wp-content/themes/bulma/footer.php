	...
	<div class="container">
		<div class="nav-center">
			...
			<a class="nav-item" href="http://qiita.com/ki6ool" title="Qiita" target="_blank">
				<span class="icon"><img src="https://cdn.qiita.com/assets/favicons/public/apple-touch-icon-f9a6afad761ec2306e10db2736187c8b.png"></span>
			</a>
		...
		<div class="content has-text-centered">
			<p>&copy;<?php echo get_option('blogname');?></p>
		</div>
	</div>
</footer>
